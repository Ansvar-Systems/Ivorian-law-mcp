 ...
 *
 * Data source: cndj.ci (National Council for Law Reporting)
...
async function main(): Promise<void> {
  ...
  console.log('====================================================\n');
  console.log(`  Source: cndj.ci (National Council for Law Reporting)`);
  ...
  console.log(`\n  Source:      cndj.ci (Akoma Ntoso HTML)`);
