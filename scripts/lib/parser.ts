/**
 * Ivory Coast (Cote d'Ivoire) Law HTML/Text Parser
 *
 * Parses French-language legislation from Ivorian legal portals.
 ...
 *
 * Source: cndj.ci (Centre National de Documentation Juridique)
 */
...
/**
 * Parse Ivorian law HTML or text content into structured provisions.
 */
export function parseIvorianLawHtml(html: string, act: ActIndexEntry): ParsedAct {
...
export function parseHtml(html: string, act: ActIndexEntry): ParsedAct {
  return parseIvorianLawHtml(html, act);
}
